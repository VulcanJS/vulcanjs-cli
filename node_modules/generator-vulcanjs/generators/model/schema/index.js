...
module.exports = class extends VulcanGenerator {
  ...
  prompting() {
    ...
    const questions = this._getQuestions('packageNameWithNumModulesList', 'modelNameList', 'isAddCustomSchemaProperty');
  ...
  _writeTestSchema() {
    ...
    this.fs.copyTpl(this.templatePath('test.js'), this._getPath({ isAbsolute: true }, 'modelTest', 'schema.js'), testFragmentsProps);
  }
