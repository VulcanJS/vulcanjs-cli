...
module.exports = class extends VulcanGenerator {
  ...
  prompting() {
    ...
    const questions = this._getQuestions('packageNameWithManualList', 'packageNameIfManual', 'modelName');
  ...
  _writeTestCollection() {
    ...
    this.fs.copyTpl(this.templatePath('generic-test.js'), this._getPath({ isAbsolute: true }, 'modelTest', 'collection.js'), testProps);
  }
