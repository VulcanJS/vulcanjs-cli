  ...
  _createClass(_class, [{
    ...
    value: function prompting() {
      ...
      if (this._needArg('componentName')) {
        questions = [].concat(_toConsumableArray(questions), _toConsumableArray(this._getQuestions('componentName')));
      }
      questions = [].concat(_toConsumableArray(questions), _toConsumableArray(this._getQuestions('componentType', 'isRegisterComponent')));
